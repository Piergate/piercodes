    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="projectTemplate">
                <div class="souqWebProjectPic col-md-5" data-aos="flip-left" data-aos-duration="1500" style="background-image: linear-gradient(to right, rgba(125, 87, 99, 0.7), rgba(115, 176, 156, 0.8)), url('../storage/app-images/{{ $product->image->avater }} ');">
        ...
        <div class="row">
            <div class="projectTemplate">
                <div class="maysaraProjectPic pull-image-right col-md-5" data-aos="flip-left" data-aos-duration="1500" style="background-image: linear-gradient(to right, rgba(125, 87, 99, 0.7), rgba(115, 176, 156, 0.8)), url('../storage/app-images/{{ $product->image->avater }} ');">
                    <a href="{{url('/product_details'.'/'.$product->slug) }}" target="_blank">Project Details</a>
                </div>
                <div class="rightProjectInfo col-md-7">
                    <div class="projectText">
