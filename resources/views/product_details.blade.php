...
@section('content')
<header class="projectHeaderSection" style="  background: linear-gradient(to right, rgba(125, 87, 99, 0.7), rgba(115, 176, 156, 0.8)), url('../storage/images/{{ $product->image->background }} ');">
			...
			<div class="projectDescription">
				...
				<div class="col-md-2">
					<div data-aos="fade-right" data-aos-duration="900" class="projectLogo">
						<img src="{{asset('storage/images/'.$product->image->logo)}}" alt="Souq Naql Logo" />
					</div>
				</div>
				<div class="col-md-6">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="mockUpPicture">
				<img data-aos="fade-right" data-aos-duration="900" src="{{asset('storage/images/'.$product->image->mockup)}}" alt="{{$product->title }} Mockup" />
			</div>
		</div>
		...
		<div class="row">
			<div data-aos="fade-left" data-aos-duration="900" class="mockUpPicture">
				<img src="{{asset('storage/images/'.$product->image->branding)}}" alt="{{ $product->title }} Branding" />
			</div>
		</div>
	</div>
</section>
