<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
    ...
    <title>Welcome to Sellerpier application</title>
    <!--[if !mso]><!-- -->
  ...
  <table class="nl-container" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #E3E8E5;width: 100%" cellpadding="0" cellspacing="0">
      <tbody>
        ...
        <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="background-color: #E3E8E5;"><![endif]-->
          ...
          <div style="background-color:transparent;">
            <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #020202;" class="block-grid ">
              <div style="border-collapse: collapse;display: table;width: 100%;background-color:#020202;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:#020202;"><![endif]-->
                ...
                <div class="col num12" style="min-width: 320px;max-width: 600px;display: table-cell;vertical-align: top;">
                  <div style="background-color: transparent; width: 100% !important;">
                    ...
                    <div align="center" class="img-container center  autowidth  fullwidth" style="padding-right: 0px;  padding-left: 0px;">
                      ...
                      <a href="http://www.sellerpier.com" target="_blank">
                        <img class="center  autowidth  fullwidth" align="center" border="0" src="https://i.imgur.com/EXpQTsU.png" alt="Sellerpier Image" title="Sellerpier Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px" width="600">
                      </a>
                  ...
                  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 30px; padding-left: 40px; padding-top: 40px; padding-bottom: 40px;"><![endif]-->
                    ...
                    <div style="display: inline-block; text-align: center; margin-bottom: 20px">
                        <div style="display: inline-block; width: 20%">
                            <img src="https://i.imgur.com/KMezjh9.png" alt="amazon logo" style="width: 100%;" />
                          </div>
                          <div style="display: inline-block; width: 20%">
                              <img src="https://i.imgur.com/J7Bmmd4.png" alt="ebay logo" style="width: 100%;" />
                            </div>
                            <div style="display: inline-block; width: 20%">
                                <img src="https://i.imgur.com/AnePFCg.png" alt="synnex logo" style="width: 100%;" />
                              </div>
                              <div style="display: inline-block; width: 20%">
                                  <img src="https://i.imgur.com/2W0Y6ix.png" alt="woocommerce logo" style="width: 100%;" />
                                </div>
                    </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                  <!--[if (!mso)&(!IE)]><!--></div><!--<![endif]-->
                    ...
                    <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:15px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                      ...
                      <div align="center" class="button-container center" style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:20px;">
                        ...
                        <div style="color: #ffffff; background-color: #f9b71a; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 206px; width: 166px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; text-align: center; mso-border-alt: none;">
                            <a href="http://www.sellerpier.com" style="color: white; text-decoration: none"><span style="line-height:24px;font-size:12px;"><span style="font-size: 20px; line-height: 40px;"><b>Get Started</b></span></span></a>
                        </div>
    ...
    <div style="background-color:transparent;">
      <div style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #f9b71a;" class="block-grid ">
        <div style="border-collapse: collapse;display: table;width: 100%;background-color:#f9b71a;">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="background-color:transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width: 600px;"><tr class="layout-full-width" style="background-color:#f9b71a;"><![endif]-->
